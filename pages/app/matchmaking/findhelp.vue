<template>
  ...
  <v-container fluid>
    <v-row align="center">
      ...
      >
        <v-btn color="primary" to="/app/matchmaking/findhelp" x-medium @click="showVolunteers">
            Search        
        </v-btn>
     </v-col>
    </v-row>
  ...
  <v-container v-show="volunteersOpened" class="volunteers fill-height" fluid style="min-height: 434px">
...
export default {
    ...
    return {
      ...
      volunteers: [
      {
          ...
          description: "My name is Lucy and I am 25 y.o. I am working as Social Media Specialist. I am a local actvivist in my neighborhood.",
          availability: ["Mon-Thu 4PM-8PM", "Fri 8AM-16PM", "Saturdays"],
          imageurl: "require('~/assets/images/lucy.png')"
      },
      {
          name: "Paul",
          surname: "Smith",
          keywords: ["Photo & Video Specialist","Spanish native speaker"],
          description: "My name is Paul and I am 34 y.o. and I am passionate about photo and video editing.",
          availability: ["Mon-Wed", "Weekends"],
          imageurl: "require('~/assets/images/paul.png')"
      }
